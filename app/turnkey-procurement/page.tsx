...
export default function TurnkeyProcurement() {
  const fadeIn = {
  ...
  const features = [
    'Complete end-to-end procurement management',
    'Strategic sourcing and vendor management',
    'Optimized costs and minimized risks',
    'Maximum transparency throughout the process',
    'Large government tender expertise',
    'Private sector initiative support'
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
              Complete, hassle-free procurement solutions from planning to delivery.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <motion.div {...fadeIn}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-dark">Our Approach</h2>
              </div>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Our turnkey procurement services offer a complete, hassle-free solution covering the entire process—from strategic sourcing and vendor management to final delivery and implementation.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                We take full ownership of procurement cycles, ensuring clients benefit from optimized costs, minimized risks, and maximum transparency. Whether for large government tenders or private sector initiatives, Axio Ventures guarantees seamless, efficient, and end-to-end procurement execution.
              </p>
            </motion.div>
            <motion.div {...fadeIn}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div {...fadeIn} className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-10 opacity-90 leading-relaxed">
              Let's discuss how our turnkey solutions can simplify your procurement process.
            </p>
