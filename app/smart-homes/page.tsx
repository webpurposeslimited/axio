...
export default function SmartHomes() {
  ...
  const features = [
    ...
    'Lifestyle-adaptive programming'
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
              Transform your living space with intelligent home automation.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <motion.div {...fadeIn}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-dark">Modern Living</h2>
              </div>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Control your home's ambiance and energy usage effortlessly with our smart lights, switches, and automated curtains. These solutions allow remote operation, scheduling, and integration with voice assistants, offering both convenience and modern living comfort.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                Our systems can be programmed to adapt to your lifestyle, from dimming lights at sunset to closing curtains for privacy. With energy efficiency at the forefront, these products not only make your home smarter but also help reduce electricity costs over time.
              </p>
            </motion.div>
            <motion.div {...fadeIn}>
              <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  src="https://i0.wp.com/xemoventures.com/wp-content/uploads/2025/08/ab7d7ec403f5b21b930c0fdf0e748bce-1.png?fit=720%2C720&ssl=1"
                  alt="Smart Homes"
                  fill
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div {...fadeIn} className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-10 opacity-90 leading-relaxed">
              Let's discuss how to transform your living space with smart automation.
            </p>
