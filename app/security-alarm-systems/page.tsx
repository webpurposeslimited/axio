...
export default function SecurityAlarmSystems() {
  const fadeIn = {
  ...
  const features = [
    'Round-the-clock intrusion protection',
    'Immediate emergency alerts',
    'High-quality sensors and sirens',
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
              Advanced alarm systems providing round-the-clock protection for your home or business.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <motion.div {...fadeIn}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-dark">Complete Protection</h2>
              </div>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Our advanced security alarm systems provide round-the-clock protection for your home or business, ensuring immediate alerts in case of intrusion or emergencies. Designed with reliability and quick response in mind, these systems integrate seamlessly with your property for maximum safety and peace of mind.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                We use high-quality sensors, sirens, and connectivity features that work in harmony to deliver precise and timely notifications. Whether connected to a monitoring center or directly to your mobile device, our systems are built to safeguard what matters most to you.
              </p>
            </motion.div>
            <motion.div {...fadeIn}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div {...fadeIn} className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-10 opacity-90 leading-relaxed">
              Let's discuss the best alarm system solution for your needs.
            </p>
